...
},{"../package.json":345,"./elliptic/curve":333,"./elliptic/curves":336,"./elliptic/ec":337,"./elliptic/eddsa":340,"./elliptic/utils":344,"brorand":4}],331:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"bn.js":3}],332:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"../curve":333,"bn.js":3,"inherits":359}],333:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"../curve":333,"bn.js":3,"inherits":359}],335:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"../curve":333,"bn.js":3,"inherits":359}],336:[function(require,module,exports){
'use strict';
...
},{"../elliptic":330,"./precomputed/secp256k1":343,"hash.js":346}],337:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"./key":338,"./signature":339,"bn.js":3,"hmac-drbg":358}],338:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"bn.js":3}],339:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"bn.js":3}],340:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"./key":341,"./signature":342,"hash.js":346}],341:[function(require,module,exports){
'use strict';
...
},{"../../elliptic":330,"bn.js":3}],343:[function(require,module,exports){
'use strict';
...
},{"bn.js":3,"minimalistic-assert":360,"minimalistic-crypto-utils":361}],345:[function(require,module,exports){
module.exports={
  "_from": "elliptic",
  "_id": "elliptic@6.4.1",
  "_inBundle": false,
  ...
  "_spec": "elliptic",
  "_where": "/Users/will/code/hotwallet/dual-crypto",
  "author": {
    "name": "Fedor Indutny",
...
},{"./hash/common":347,"./hash/hmac":348,"./hash/ripemd":349,"./hash/sha":350,"./hash/utils":357}],347:[function(require,module,exports){
'use strict';
...
},{"./utils":357,"minimalistic-assert":360}],348:[function(require,module,exports){
'use strict';
...
},{"./utils":357,"minimalistic-assert":360}],349:[function(require,module,exports){
'use strict';
...
},{"./common":347,"./utils":357}],350:[function(require,module,exports){
'use strict';
...
},{"./sha/1":351,"./sha/224":352,"./sha/256":353,"./sha/384":354,"./sha/512":355}],351:[function(require,module,exports){
'use strict';
...
},{"../common":347,"../utils":357,"./common":356}],352:[function(require,module,exports){
'use strict';
...
},{"../utils":357,"./256":353}],353:[function(require,module,exports){
'use strict';
...
},{"../common":347,"../utils":357,"./common":356,"minimalistic-assert":360}],354:[function(require,module,exports){
'use strict';
...
},{"../utils":357,"./512":355}],355:[function(require,module,exports){
'use strict';
...
},{"../common":347,"../utils":357,"minimalistic-assert":360}],356:[function(require,module,exports){
'use strict';
...
},{"inherits":359,"minimalistic-assert":360}],358:[function(require,module,exports){
'use strict';
...
},{"hash.js":346,"minimalistic-assert":360,"minimalistic-crypto-utils":361}],359:[function(require,module,exports){
'use strict';
...
var bufToStr = function bufToStr(str) {
...
var generateMasterKey = function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt('return', crypto.subtle.importKey('raw', stringToArrayBuffer(password), { name: 'PBKDF2' }, false, ['deriveKey', 'deriveBits']));
  ...
  return function generateMasterKey(_x) {
    return _ref.apply(this, arguments);
  };
}();

var generateSymmetricKey = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(masterKey, salt, iterations) {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return crypto.subtle.deriveKey({
              ...
              hash: 'SHA-256'
            }, masterKey, { name: 'AES-GCM', 'length': 128 }, true, ['encrypt', 'decrypt']);
  ...
  return function generateSymmetricKey(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

var generateAsymmetricKeyPair = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(masterKey, salt, iterations) {
    var entropy;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            entropy = _context3.sent;

            entropy = new Uint8Array(entropy);
            return _context3.abrupt('return', ec.genKeyPair({ entropy: entropy }));
  ...
  return function generateAsymmetricKeyPair(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

var sha256 = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(str) {
    var arrayBuffer;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            return _context4.abrupt('return', arrayBufferToHexString(arrayBuffer));
  ...
  return function sha256(_x8) {
    return _ref4.apply(this, arguments);
  };
}();

var DualCrypto = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
    var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        secret = _ref6.secret,
        salt = _ref6.salt,
        _ref6$iterations = _ref6.iterations,
        iterations = _ref6$iterations === undefined ? 1000000 : _ref6$iterations;

    var saltReverse, masterKey, symmetric, asymmetric, symmetricAlgo;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 6:
            ...
            _context8.next = 9;
            return generateSymmetricKey(masterKey, sha256(salt), iterations);

          case 9:
            symmetric = _context8.sent;
            _context8.next = 12;
            return generateAsymmetricKeyPair(masterKey, sha256(saltReverse), iterations);

          case 12:
            asymmetric = _context8.sent;
            ...
            return _context8.abrupt('return', {
              ...
              sign: function () {
                var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(message) {
                  var hash;
                  return regeneratorRuntime.wrap(function _callee5$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        ...
                        case 2:
                          hash = _context5.sent;
                          return _context5.abrupt('return', asymmetric.sign(hash).toDER('hex'));
              ...
              encrypt: function () {
                var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(message) {
                  var data, iv, encryptedData;
                    ...
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        ...
                        case 4:
                          ...
                          return _context6.abrupt('return', arrayBufferToHexString(iv) + arrayBufferToHexString(encryptedData));
              ...
              decrypt: function () {
                var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(encryptedMessage) {
                  var iv, data, decryptedData;
                  return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        case 0:
                          iv = hexToBuf(encryptedMessage.substring(0, 32));
                          data = hexToBuf(encryptedMessage.substring(32));
                          _context7.next = 4;
                        ...
                        case 4:
                          ...
                          return _context7.abrupt('return', bufToStr(decryptedData));
  ...
  return function DualCrypto() {
    return _ref5.apply(this, arguments);
  };
}();

exports.default = DualCrypto;


DualCrypto.verify = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
  ...
  return regeneratorRuntime.wrap(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 3:
          hash = _context9.sent;
          return _context9.abrupt('return', key.verify(hash, signature));
...
},{"babel-polyfill":1,"elliptic":330}]},{},[362]);
